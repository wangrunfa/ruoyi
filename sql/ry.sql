...
-- ----------------------------
-- Table structure for qd_basicmanager
-- ----------------------------
DROP TABLE IF EXISTS `qd_basicmanager`;
CREATE TABLE `qd_basicmanager` (
  `lg_shop_uid` int(11) NOT NULL AUTO_INCREMENT COMMENT '用户表购买id',
  `qd_gm_pay` int(11) NOT NULL,
  `qd_fb_time` datetime NOT NULL ON UPDATE CURRENT_TIMESTAMP,
  `qd_sesame` int(5) NOT NULL COMMENT '芝麻分',
  `qd_wechat` varchar(255) NOT NULL,
  `qd_qq` varchar(255) NOT NULL,
  `qd_phone` int(15) NOT NULL COMMENT '抢单列表中用户手机号',
  `qd_username` varchar(255) NOT NULL COMMENT '渠道用户名称',
  `qd_loanpay` int(11) NOT NULL COMMENT '渠道贷款金额',
  `qd_time` varchar(255) NOT NULL COMMENT '渠道用户显示期限',
  `qd_region` varchar(255) NOT NULL COMMENT '渠道用户地区',
  `qd_age` varchar(255) NOT NULL COMMENT '渠道用户年龄',
  `qd_Professional` varchar(255) NOT NULL COMMENT '渠道用户职业',
  `qd_often` varchar(255) NOT NULL COMMENT '渠道学历',
  `qd_social` varchar(255) NOT NULL COMMENT '渠道用户社保',
  `qd_plicy` varchar(255) NOT NULL COMMENT '渠道用户保单',
  `qd_assets` varchar(255) NOT NULL COMMENT '渠道用户资产',
  `qd_card` varchar(255) NOT NULL COMMENT '渠道用户身份证号',
  `qd_marriage` varchar(255) NOT NULL COMMENT '渠道用户婚姻情况',
  `qd_sex` varchar(255) NOT NULL COMMENT '渠道用户性别',
  `qd_dress` varchar(255) NOT NULL COMMENT '渠道用户现住地址',
  `qd_fund` varchar(255) NOT NULL COMMENT '渠道用户公积金',
  `qd_credit` varchar(255) NOT NULL COMMENT '渠道信用卡',
  `qd_source` varchar(255) NOT NULL COMMENT '渠道用户来源',
  `qd_department` varchar(255) DEFAULT NULL,
  `qd_liveltervals` varchar(255) DEFAULT NULL,
  `qd_phone_live` varchar(255) NOT NULL COMMENT '手机号在网时长',
  `qd_phone_staus` varchar(255) NOT NULL COMMENT '手机号当前状态',
  `qd_court-ordered` varchar(255) NOT NULL COMMENT '是否在法院失信名单',
  `qd_domicile` varchar(255) NOT NULL COMMENT '户籍地',
  `qd_Undercity` varchar(255) NOT NULL COMMENT '现居地是否定位城市',
  `qd_phone_city` varchar(255) NOT NULL COMMENT '主要通话区域',
  `qd_card_list` varchar(255) NOT NULL COMMENT '身份证是否在信贷行业逾期名单',
  `qd_loan_phone` varchar(255) NOT NULL COMMENT '贷款类号码通话情况',
  `qd_new_address` varchar(255) NOT NULL COMMENT '现居地',
  `qd_user_matching` varchar(255) NOT NULL COMMENT '用户姓名与运营数据是否匹配',
  `qd_ht_phone` varchar(255) NOT NULL COMMENT '互通号码个数',
  `qd_phone_loan_list` varchar(255) NOT NULL,
  `qd_cs_phone` varchar(255) NOT NULL,
  `qd_jobs` varchar(255) NOT NULL COMMENT '渠道用户职业',
  `qd_units` varchar(255) NOT NULL COMMENT '渠道工作单位',
  `qd_units_dress` varchar(255) NOT NULL COMMENT '渠道工作单位地址',
  `qd_income` varchar(255) NOT NULL COMMENT '渠道用户月收入',
  `qd_salary` varchar(255) NOT NULL COMMENT '渠道用户发放薪水日期',
  PRIMARY KEY (`lg_shop_uid`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;

-- ----------------------------
-- Records of qd_basicmanager
-- ----------------------------
INSERT INTO `qd_basicmanager` VALUES ('1', '0', '0000-00-00 00:00:00', '666', 'wechar123', 'qq123', '1111111111', '隔壁老王', '20000', '14天', '高中', '16', 'it狗', '有,连续缴纳半年以上', '无', '有房无车', '无', '130434199806062411', '未婚', '男', '渝北', '无', '有，逾期', '来源001', null, null, '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '');

-- ----------------------------
-- Table structure for qd_lg_power
-- ----------------------------
DROP TABLE IF EXISTS `qd_lg_power`;
CREATE TABLE `qd_lg_power` (
  `id` int(10) NOT NULL,
  `lg_phone` varchar(255) NOT NULL COMMENT '登录后手机号权限',
  `lg_read` varchar(255) NOT NULL COMMENT '1.已读2.未读',
  `lg_shop_uid` int(15) NOT NULL COMMENT '购买客户查询id',
  `lg_addtime` datetime NOT NULL ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of qd_lg_power
-- ----------------------------
...
CREATE TABLE `qd_user` (
  `id` int(11) NOT NULL,
  `lg_username` varchar(255) DEFAULT NULL,
  `lg_phone` varchar(255) DEFAULT NULL,
  `lg_password` varchar(255) DEFAULT NULL,
  `lg_balance` int(255) DEFAULT NULL,
  `lg_sex` varchar(255) DEFAULT NULL,
  `lg_ip` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
-- ----------------------------
INSERT INTO `qrtz_scheduler_state` VALUES ('RuoyiScheduler', 'DESKTOP-1895EQS1583572900372', '1583650044068', '15000');
...
-- ----------------------------
INSERT INTO `qrtz_triggers` VALUES ('RuoyiScheduler', 'TASK_CLASS_NAME1', 'DEFAULT', 'TASK_CLASS_NAME1', 'DEFAULT', null, '1583572900000', '-1', '5', 'PAUSED', 'CRON', '1583572900000', '0', null, '2', '');
INSERT INTO `qrtz_triggers` VALUES ('RuoyiScheduler', 'TASK_CLASS_NAME2', 'DEFAULT', 'TASK_CLASS_NAME2', 'DEFAULT', null, '1583572905000', '-1', '5', 'PAUSED', 'CRON', '1583572900000', '0', null, '2', '');
INSERT INTO `qrtz_triggers` VALUES ('RuoyiScheduler', 'TASK_CLASS_NAME3', 'DEFAULT', 'TASK_CLASS_NAME3', 'DEFAULT', null, '1583572920000', '-1', '5', 'PAUSED', 'CRON', '1583572901000', '0', null, '2', '');
...
-- ----------------------------
INSERT INTO `sys_logininfor` VALUES ('100', 'admin', '127.0.0.1', '内网IP', 'Firefox 7', 'Windows 10', '1', '验证码错误', '2020-03-07 17:22:21');
INSERT INTO `sys_logininfor` VALUES ('101', 'admin', '127.0.0.1', '内网IP', 'Firefox 7', 'Windows 10', '1', '验证码错误', '2020-03-07 17:24:50');
INSERT INTO `sys_logininfor` VALUES ('102', 'admin', '127.0.0.1', '内网IP', 'Firefox 7', 'Windows 10', '0', '登录成功', '2020-03-07 17:24:59');
INSERT INTO `sys_logininfor` VALUES ('103', 'admin', '127.0.0.1', '内网IP', 'Firefox 7', 'Windows 10', '0', '退出成功', '2020-03-07 17:27:10');
INSERT INTO `sys_logininfor` VALUES ('104', 'admin', '127.0.0.1', '内网IP', 'Firefox 7', 'Windows 10', '0', '登录成功', '2020-03-07 17:29:14');
INSERT INTO `sys_logininfor` VALUES ('105', 'admin', '127.0.0.1', '内网IP', 'Firefox 7', 'Windows 10', '0', '登录成功', '2020-03-07 17:39:29');
INSERT INTO `sys_logininfor` VALUES ('106', 'admin', '127.0.0.1', '内网IP', 'Firefox 7', 'Windows 10', '0', '退出成功', '2020-03-07 17:44:40');
INSERT INTO `sys_logininfor` VALUES ('107', 'admin', '127.0.0.1', '内网IP', 'Firefox 7', 'Windows 10', '1', '验证码错误', '2020-03-07 17:46:30');
INSERT INTO `sys_logininfor` VALUES ('108', 'admin', '127.0.0.1', '内网IP', 'Firefox 7', 'Windows 10', '1', '验证码错误', '2020-03-07 17:46:34');
INSERT INTO `sys_logininfor` VALUES ('109', 'admin', '127.0.0.1', '内网IP', 'Firefox 7', 'Windows 10', '0', '登录成功', '2020-03-07 17:47:19');
INSERT INTO `sys_logininfor` VALUES ('110', 'admin', '127.0.0.1', '内网IP', 'Firefox 7', 'Windows 10', '0', '退出成功', '2020-03-07 17:49:18');
INSERT INTO `sys_logininfor` VALUES ('111', 'wrf', '127.0.0.1', '内网IP', 'Firefox 7', 'Windows 10', '0', '登录成功', '2020-03-07 17:49:33');
INSERT INTO `sys_logininfor` VALUES ('112', 'wrf', '127.0.0.1', '内网IP', 'Firefox 7', 'Windows 10', '0', '退出成功', '2020-03-07 17:54:54');
INSERT INTO `sys_logininfor` VALUES ('113', 'admin', '127.0.0.1', '内网IP', 'Firefox 7', 'Windows 10', '0', '登录成功', '2020-03-07 17:55:09');
...
-- ----------------------------
INSERT INTO `sys_oper_log` VALUES ('100', '重置密码', '2', 'com.ruoyi.web.controller.system.SysProfileController.resetPwd()', 'POST', '1', 'admin', '研发部门', '/system/user/profile/resetPwd', '127.0.0.1', '内网IP', '{\r\n  \"oldPassword\" : [ \"admin123\" ],\r\n  \"newPassword\" : [ \"123456\" ],\r\n  \"confirmPassword\" : [ \"123456\" ]\r\n}', '{\r\n  \"msg\" : \"操作成功\",\r\n  \"code\" : 0\r\n}', '0', null, '2020-03-07 17:43:36');
INSERT INTO `sys_oper_log` VALUES ('101', '用户管理', '2', 'com.ruoyi.web.controller.system.SysUserController.changeStatus()', 'POST', '1', 'admin', '研发部门', '/system/user/changeStatus', '127.0.0.1', '内网IP', '{\r\n  \"userId\" : [ \"1\" ],\r\n  \"status\" : [ \"1\" ]\r\n}', 'null', '1', '不允许操作超级管理员用户', '2020-03-07 17:47:52');
INSERT INTO `sys_oper_log` VALUES ('102', '用户管理', '1', 'com.ruoyi.web.controller.system.SysUserController.addSave()', 'POST', '1', 'admin', '研发部门', '/system/user/add', '127.0.0.1', '内网IP', '{\r\n  \"deptId\" : [ \"109\" ],\r\n  \"userName\" : [ \"wrf\" ],\r\n  \"deptName\" : [ \"财务部门\" ],\r\n  \"phonenumber\" : [ \"18385295580\" ],\r\n  \"email\" : [ \"18385295580@qq.com\" ],\r\n  \"loginName\" : [ \"wrf\" ],\r\n  \"password\" : [ \"123456\" ],\r\n  \"sex\" : [ \"2\" ],\r\n  \"role\" : [ \"1\" ],\r\n  \"remark\" : [ \"\" ],\r\n  \"status\" : [ \"0\" ],\r\n  \"roleIds\" : [ \"1\" ],\r\n  \"postIds\" : [ \"4\" ]\r\n}', '{\r\n  \"msg\" : \"操作成功\",\r\n  \"code\" : 0\r\n}', '0', null, '2020-03-07 17:49:14');
INSERT INTO `sys_oper_log` VALUES ('103', '个人信息', '2', 'com.ruoyi.web.controller.system.SysProfileController.updateAvatar()', 'POST', '1', 'wrf', '财务部门', '/system/user/profile/updateAvatar', '127.0.0.1', '内网IP', '{ }', '{\r\n  \"msg\" : \"操作成功\",\r\n  \"code\" : 0\r\n}', '0', null, '2020-03-07 17:49:59');
INSERT INTO `sys_oper_log` VALUES ('104', '个人信息', '2', 'com.ruoyi.web.controller.system.SysProfileController.update()', 'POST', '1', 'wrf', '财务部门', '/system/user/profile/update', '127.0.0.1', '内网IP', '{\r\n  \"id\" : [ \"\" ],\r\n  \"userName\" : [ \"wrf\" ],\r\n  \"phonenumber\" : [ \"18385295580\" ],\r\n  \"email\" : [ \"18385295580@qq.com\" ],\r\n  \"sex\" : [ \"0\" ]\r\n}', '{\r\n  \"msg\" : \"操作成功\",\r\n  \"code\" : 0\r\n}', '0', null, '2020-03-07 17:51:05');
INSERT INTO `sys_oper_log` VALUES ('105', '用户管理', '3', 'com.ruoyi.web.controller.system.SysUserController.remove()', 'POST', '1', 'admin', '研发部门', '/system/user/remove', '127.0.0.1', '内网IP', '{\r\n  \"ids\" : [ \"100\" ]\r\n}', '{\r\n  \"msg\" : \"操作成功\",\r\n  \"code\" : 0\r\n}', '0', null, '2020-03-07 21:40:21');
INSERT INTO `sys_oper_log` VALUES ('106', '用户管理', '3', 'com.ruoyi.web.controller.system.SysUserController.remove()', 'POST', '1', 'admin', '研发部门', '/system/user/remove', '127.0.0.1', '内网IP', '{\r\n  \"ids\" : [ \"2\" ]\r\n}', '{\r\n  \"msg\" : \"操作成功\",\r\n  \"code\" : 0\r\n}', '0', null, '2020-03-07 21:40:25');
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES ('1', '103', 'admin', '若依', '00', 'ry@163.com', '15888888888', '1', '', 'd800c3b5e0c7b40ea93d75664236b2ed', 'cef70f', '0', '0', '127.0.0.1', '2020-03-07 17:55:10', 'admin', '2018-03-16 11:33:00', 'ry', '2020-03-07 17:55:09', '管理员');
...
INSERT INTO `sys_user` VALUES ('100', '109', 'wrf', 'wrf', '00', '18385295580@qq.com', '18385295580', '0', '/profile/avatar/2020/03/07/bee8a7e062ed8eab3f5089f3bb0b51b0.png', '6a0d2ebefc2aea3b0b5fc55a8ce50f46', '09bb50', '0', '2', '127.0.0.1', '2020-03-07 17:49:33', 'admin', '2020-03-07 17:49:14', '', '2020-03-07 17:51:05', null);
